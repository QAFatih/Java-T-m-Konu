...
/* Tom 29 Ekim 1923 tarihinden 45 yil 8 ay 5 gun sonra dogdu.
  Veli 15 Eylul 1993 tarihinden 24 yil 2 ay 11 önce dogdu.
 ...
 */
  ...
  /*
        ...
        System.out.println();
        //İki saat dilimi arasında ki saat dilimi arasındaki farki hesaplatan kodu yaziniz.

        LocalDateTime farkAlmanya = LocalDateTime.now(ZoneId.of("Europa/Berlin"));
        LocalDateTime farkJaponya = LocalDateTime.now(ZoneId.of("Asya/Tokyo"));
