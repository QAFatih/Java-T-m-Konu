...
*/
    ...
    private static void testsonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length; i++) {//herbir ögrenciyi dolastik i=ogrenci
            int sayac = 0;//herbir ögrencinin dogru cevap sayisi
            for (int j = 0; j < answers[i].length; j++) {//her ögrencinin cevaplari j=cevaplar
